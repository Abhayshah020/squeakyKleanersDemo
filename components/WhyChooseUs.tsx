...
import { CheckCircle, Leaf, Star, Calendar, DollarSign, FileCheck, Sparkles } from "lucide-react";
...
const data = [
    ...
    {
        icon: <Calendar className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
    ...
    {
        icon: <FileCheck className="w-5 sm:w-6 h-5 sm:h-6 text-blue-700" />,
