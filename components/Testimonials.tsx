...
const reviews: Review[] = [
    ...
    {
        review: "Squeaky Kleaners have been a lifesaver for our firm! Our clients constantly comment on how clean and fresh our office feels. The attention to detail is spot on – not a speck of dust in sight. The team is friendly, trustworthy, and always goes the extra mile. Couldn’t ask for better service here in Sydney!",
        rate: 5,
        name: "Sarah O'Conors",
        position: "Operations Director, Harbour Lane Law Firm",
    },
    {
        review: "Top service from the Squeaky Kleaners crew! They handle our massive commercial space with ease – floors, bathrooms, windows, you name it. Super efficient and always flexible when we have events or late shifts. If you’re looking for quality commercial cleaning in Sydney, these guys are the real deal.",
        rate: 4,
        name: "Lachlan Evans",
        position: "Facilities Coordinator, Sydney City Markets",
    },
    {
        review: "Running a busy medical centre, cleanliness is crucial – and Squeaky Kleaners have exceeded all expectations. Their team is professional, discreet, and follows all hygiene protocols perfectly. They’re a huge part of keeping our workplace safe and welcoming. I wouldn't trust anyone else for commercial cleaning around Sydney!",
        rate: 3.5,
        name: "Mia Campbell",
